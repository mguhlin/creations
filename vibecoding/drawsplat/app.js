...
async function smartCopy(){copySelection(); if(selectedIds.length===1){const o=currentObj(); if(o&&o.type==='image'&&o.src&&navigator.clipboard&&navigator.clipboard.write&&typeof ClipboardItem!=='undefined'){try{const res=await fetch(o.src); const blob=await res.blob(); await navigator.clipboard.write([new ClipboardItem({[blob.type]:blob})]); setStatus('Image copied to clipboard.','success')}catch(_){}}}}
