...
(async function init(){
  ...
  document.title='DrawSplat v'+VERSION+' - K-16 Interactive Whiteboard';
...
(function(){
  ...
  const keepTextIds=new Set(['saveDriveBtn','exportBtn','exportPdfBtn','tntBtn','submitTurnInBtn','reviewTurnInsBtn','openModerationBtn','refreshModerationBtn','settingsBtn','loadDriveBtn','saveLocalBtn','loadLocalBtn','inlineTextSaveBtn','inlineTextCancelBtn','optionsBtn']);
